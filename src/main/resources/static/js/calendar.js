...
;!function (a) {
    ...
    a.laydate = function (b) {
        ...
        var a = c.options.format.replace(/YYYY|MM|DD|hh/g, "\\d+\\").replace(/\\$/g, ""), b = new RegExp(a), d = c.elem[h.elemv], e = d.match(/\d+/g) || [], f = c.checkVoid(e[0], e[1], e[2]);
        if ("" !== d.replace(/\s/g, "")) {
        ...
        return a = a.concat(d), e = e || (c.options ? c.options.format : b.format), e.replace(/YYYY|MM|DD|hh/g, function () {
        ...
        return c.parse([d.getFullYear(), d.getMonth() + 1, d.getDate()], [d.getHours()], b)
    }
}(window);